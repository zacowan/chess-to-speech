...
# Quiteness threshold adjust this to adjust min volume required for End Point Detection
THRESHOLD = 1800
CHUNK_SIZE = 1024
...
def record():
    ...
    while not theMain.isClosed():
        ...
        # Ending conditions Silent for more than 50 iterations and total audio grater than 700 iterations
        if snd_started and (num_silent > 60 or num_len > 700):
            break
