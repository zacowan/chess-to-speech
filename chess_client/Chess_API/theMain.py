...
init_complete = False #May not need, dependent on Rest API testing, For now I will leave this here
...
def main():
    ...
    audio = threading.Thread(target= audioEngine.setupAudioEngine)  # @IgnorePep8
