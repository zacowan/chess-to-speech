...
RESPONSE_TYPES = Enum(
    "RESPONSE_TYPES",
    "HELLO FALLBACK CHOOSE_SIDE MOVE_PIECE HOW_PIECE_MOVES BEST_MOVE START_GAME POSSIBLE_ACTIONS ERROR UNDO_MOVE RESTART_GAME RESTART_GAME_YES RESTART_GAME_NO QUIT_GAME QUIT_GAME_YES QUIT_GAME_NO SELECT_DIFFICULTY"
)
